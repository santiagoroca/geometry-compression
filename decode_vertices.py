...
class VerticesDecoder():
    ...
    def decode (self, data, t, uv):
        ...
        # Bit, represents the index of the current number beeing proccessed
        # Since all the outputs will be 9bit integers, bit will decrease down
        # to 0 for every number procceseds
